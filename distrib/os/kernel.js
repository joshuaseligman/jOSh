        ...
        krnInterruptHandler(irq, params) {
            ...
            switch (irq) {
                ...
                case MEM_EXCEPTION_IRQ:
                    ...
                    _CPU.init();
                    this.krnTrace(`Process ${exitedProgram.pid} terminated with status code 1. Memory out of bounds exception. Requested Addr: ${TSOS.Utils.getHexString(params[0], 0, true)}; Section: ${params[1]}`);
                    break;
                default:
